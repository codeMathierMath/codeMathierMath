...
- real experiments (including failures)
...
Expect exploratory code, math notes, and iterative refinement.
...
![Game of Life Demo](~/Projects/conway_game_of_life/media/game_of_life_demo.gif)
